    ...
    <section id="contact" className="w-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <a href="www.linkedin.com/in/sai-chandra-7b2528250" target="_blank" rel="noopener noreferrer" className="rounded-full border border-white/30 px-4 py-2 text-sm font-medium text-white hover:bg-white/10">LinkedIn</a>
        </div>
      </div>
    </section>
  );
